...
This is a wrapper script that provides CLI access to the lzss.py module.
All compression logic is in lzss.py.
"""

# Import compression function from shared module
