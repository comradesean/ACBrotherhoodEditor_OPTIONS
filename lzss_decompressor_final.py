...
def run_tests():
    ...
    compressed_file = '/mnt/f/ClaudeHole/assassincreedbrotherhood/game_compressed_2.bin'
    uncompressed_file = '/mnt/f/ClaudeHole/assassincreedbrotherhood/game_uncompressed_2.bin'
    ...
    output_file = '/mnt/f/ClaudeHole/assassincreedbrotherhood/lzss_uncompressed.bin'
    with open(output_file, 'wb') as f:
        f.write(result)
